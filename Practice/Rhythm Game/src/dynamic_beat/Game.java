...
public class Game extends Thread{
	...
	public void screenDraw(Graphics2D g) {
		...
		g.drawImage(blueFlareImage, 240, 260, null);
	...
	public void dropNotes(String titleName) {
		...
		else if(titleName.equals("Ben Sound - Energy") && difficulty.equals("Easy")) {
			int startTime = 1000;
			beats = new Beat[] {
					new Beat(startTime, "Space"),
			};
		}
		else if(titleName.equals("Ben Sound - Energy") && difficulty.equals("Hard")) {
			int startTime = 1000;
			beats = new Beat[] {
					new Beat(startTime, "Space"),
			};
